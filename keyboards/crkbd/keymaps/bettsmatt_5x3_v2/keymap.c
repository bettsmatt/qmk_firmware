...
// qmk compile -kb crkbd -km bettsmatt_5x3_v2 && cp .build/crkbd_rev1_bettsmatt_5x3_v2.hex /mnt/c/Users/iplk/Documents/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAV] = LAYOUT(
  //,-----------------------------------------------------.        ,-----------------------------------------------------.
      _______, C(KC_Q), C(KC_W), C(KC_F), C(KC_P), C(KC_G),          XXXXXXX, KC_BSPC,   KC_UP,  KC_DEL, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------,        ,--------+--------+--------+--------+--------+--------|
      _______, KC_OGUI, KC_OALT, KC_OCTL, KC_OSFT, C(KC_D),           KC_TAB, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------,        ,--------+--------+--------+--------+--------+--------|
      _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), C(KC_B),          KC_STAB,  KC_ENT, XXXXXXX, XXXXXXX, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------,        ,--------+--------+--------+--------+--------+--------|
                                 _______, _______, _______,          _______, _______, _______
  //                           +--------+--------+--------+        +--------+--------+--------+
  ),
  ...
  [_SYM] = LAYOUT(
  //,-----------------------------------------------------.        ,-----------------------------------------------------.
      _______, KC_SLSH, KC_BSLS, KC_QUOT,  KC_GRV, KC_SCLN,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------,        ,--------+--------+--------+--------+--------+--------|
      _______, KC_LBRC, KC_LPRN, KC_UNDS, KC_RPRN, KC_RBRC,          XXXXXXX, KC_OSFT, KC_OCTL, KC_OALT, KC_OGUI, _______,
  //|--------+--------+--------+--------+--------+--------,        ,--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------,        ,--------+--------+--------+--------+--------+--------|
      _______, KC_OGUI, KC_OALT, KC_OCTL, KC_OSFT, KC_PGDN,          XXXXXXX,    KC_4,    KC_5,    KC_6,    KC_0, _______,
  //|--------+--------+--------+--------+--------+--------,        ,--------+--------+--------+--------+--------+--------|
      _______, XXXXXXX,   KC_CL,   KC_CU,   KC_CR,  KC_PIC,          KC_LBRC,    KC_7,    KC_8,    KC_9, KC_LBRC, _______,
  //|--------+--------+--------+--------+--------+--------,        ,--------+--------+--------+--------+--------+--------|
                                 _______, _______, _______,          _______, _______, _______
  //                           +--------+--------+--------+        +--------+--------+--------+
  ),
