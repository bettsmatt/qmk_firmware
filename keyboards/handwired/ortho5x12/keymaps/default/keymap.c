...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------+
     XXXXXXX ,XXXXXXX ,KC_LGUI ,KC_LALT ,KC_LAYR ,KC_SPC  ,KC_LSFT ,KC_LAYR ,KC_LGUI ,KC_LCTL ,XXXXXXX ,XXXXXXX
  //`--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------+
  ),
 ...
 // COLMK Default layer
  ...
  //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
     KC_LSFT ,KC_A    ,KC_R    ,KC_S    ,KC_T    ,KC_D    ,KC_H    ,KC_N    ,KC_E    ,KC_I    ,KC_O    ,KC_QUOTE,
  //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
     KC_LCTL ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,KC_K    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH ,KC_ENTER ,
  //|--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------+
     KC_LAYR ,XXXXXXX ,KC_LGUI ,KC_LALT ,KC_LAYR ,KC_SPC  ,KC_LSFT ,KC_LAYR ,KC_LGUI ,KC_LCTL ,XXXXXXX ,XXXXXXX
  //`--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------+
  ),
...
//   ),
  ...
  //,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
     _______ ,KC_BSLS ,KC_LBRC , KC_GRV ,KC_RBRC ,KC_PIPE ,XXXXXXX ,KC_BSPC ,KC_UP   ,KC_DEL  ,KC_PGUP ,_______ ,
  //,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
     _______ ,KC_LCBR ,KC_LPRN ,KC_UNDS ,KC_RPRN ,KC_RCBR ,XXXXXXX ,KC_LEFT ,KC_DOWN ,KC_RGHT ,KC_PGDN ,_______ ,
  //,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
     _______ ,XXXXXXX ,KC_PLUS ,KC_MINS ,KC_EQL  ,KC_CAPS ,XXXXXXX ,KC_HOME ,XXXXXXX ,KC_END  ,KC_INS  ,_______ ,
  //,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
...
[_FN] = LAYOUT(
  ...
  //,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
     _______ ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,DF_QWERT,XXXXXXX ,XXXXXXX ,KC_F11  ,KC_F12  ,_______ ,
  //,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
     _______ ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,DF_COLMK,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,_______ ,
  //,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
